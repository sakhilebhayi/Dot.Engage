...
return [
    ...
    */
    ...
    'disks' => [
        ...
        /*
        |----------------------------------------------------------------------
        | Dot.Engage — Private Application Disks
        |----------------------------------------------------------------------
        |
        | These disks store sensitive files that must never be publicly
        | accessible via the web server.  Each disk lives under
        | storage/app/private/<name>/ and is served only through controlled
        | application responses (e.g. Storage::download()).
        |
        */
