...
<head>
    ...
    <style>
        :root { --accent: #a855f7; --accent-rgb: 168,85,247; }
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .sidebar::before { content:''; position:absolute; top:-80px; left:-80px; width:320px; height:320px; background:radial-gradient(circle, rgba(168,85,247,0.1) 0%, transparent 65%); pointer-events:none; }

        .sidebar-brand { padding:20px 18px 14px; display:flex; align-items:center; gap:11px; flex-shrink:0; }
        .brand-icon { width:36px; height:36px; border-radius:10px; background:rgba(168,85,247,0.12); border:1px solid rgba(168,85,247,0.22); display:flex; align-items:center; justify-content:center; flex-shrink:0; }
        .brand-icon .material-symbols-rounded { font-size:18px; color:#a855f7; }
        ...
        .live-dot { width:6px; height:6px; border-radius:50%; background:#a855f7; flex-shrink:0; animation:live-pulse 2.8s ease-in-out infinite; }
        @keyframes live-pulse { 0%,100% { opacity:1; box-shadow:0 0 0 0 rgba(168,85,247,0.45); } 60% { opacity:.6; box-shadow:0 0 0 5px rgba(168,85,247,0); } }
        ...
        .nav-item.active { background:rgba(168,85,247,0.1); color:#a855f7; font-weight:600; }
        ...
        .user-avatar { width:28px; height:28px; border-radius:50%; background:rgba(168,85,247,0.18); border:1px solid rgba(168,85,247,0.28); display:flex; align-items:center; justify-content:center; font-size:11px; font-weight:700; color:#a855f7; flex-shrink:0; font-family:'Syne',sans-serif; }
        ...
        .dot-input:focus { border-color:rgba(168,85,247,0.45); box-shadow:0 0 0 3px rgba(168,85,247,0.07); }
        ...
        .dot-btn-primary { background:#a855f7; color:#09090b; }
        ...
        .dot-badge-accent { background:rgba(168,85,247,0.12); color:#a855f7; }
...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                <div class="brand-name">Dot.Engage</div>
                <div class="brand-status">
                    <div class="live-dot"></div>
                    <span class="brand-subtitle">Client Engagement</span>
                </div>
            </div>
        </div>
    ...
    <header class="topbar">
        <div class="topbar-title">
            @isset($header){{ $header }}@else Dot.Engage
            @endisset
        </div>
        @auth
